...
<!--                    <div class="col-sm-6">
        ...
        <div align="center">
          <h3 style="color:red">
                 ...
                 {!! Form::open(['url' => '/save-customer-check', 'method'=>'post']) !!}
                    <div class="col-sm-6">
                        <h4>Login</h4>
                        <p>Already registered? Please log in below:</p>
                        <label>Email address</label>
<!--                         Form::text('email_address',null,['placeholder'=>'Username'])!!}-->
                        <input type="email_address" name="email_address" class="form-control input">
                    ...
                    <li class="row"> 
                        <div class="col-xs-6">
                         ...
                         <div class="col-sm-6">
                            ...
                            <input class="input form-control" type="text" name="mobile_number" id="telephone">
                        </div><!--/ [col] -->
