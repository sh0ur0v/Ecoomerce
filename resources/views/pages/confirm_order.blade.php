        ...
        <div class="page-content checkout-page">
            ...
            <div class="box-border">
                <ul>
                    ...
                    <li>
                        <label for="radio_button_5"><input type="radio" checked name="payment_type" value="cash on delivery" id="radio_button_5"> Cash On Delivery</label>
                    </li>
                    <li>
                        <label for="radio_button_5"><input type="radio" checked name="payment_type" value="bkash" id="radio_button_5"> Bkash</label>
                    </li>
