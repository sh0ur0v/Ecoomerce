            ...
            <div class="widget-body">
                ...
                <form action="#" class="form-horizontal">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="product_name" class="span6 " />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea class="span6 " name="short_description" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="number" name="new_price" class="span6 " />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="number" name="old_price" class="span6 " />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="number" name="stock" class="span6 " />
